...
def get_timestamp_published(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'fortunascorner.com',             '//meta[@property="article:published_time"]/@content' ),
        ...
        ( 'fromthetrenchesworldreport.com', '//meta[@property="article:published_time"]/@content' ),
        ( 'funtobebad.blogspot.com',        '//h2[@class="date-header"]/span'),
        ( 'gawker.com',                     '//div[@class="meta__text"]/time/@datetime'),
        ( 'gistmagazine.wordpress.com',     '//meta[@property="article:published_time"]/@content' ),
        ( 'gizmodo.com',                    '//meta[@name="publish-date"]/@content'),
        ( 'globalnews.ca',                  '//div[@class="c-byline__date c-byline__date--pubDate"]/span'),
        ( 'globalvoices.org',               '//meta[@property="article:published_time"]/@content' ),
        ( 'globegazette.com',               '//meta[@name="parsely-pub-date"]/@content' ),
        ( 'greatamericandaily.com',         '//meta[@property="article:published_time"]/@content'),
        ( 'greaterlakewood.com',            '//meta[@property="article:published_time"]/@content'),
        ( 'guardian.ng',                    '//meta[@property="article:published_time"]/@content'),
        ( 'guardianlv.com',                 '//meta[@property="article:published_time"]/@content'),
        ...
        ( 'hamodia.com',                    '//meta[@property="article:published_time"]/@content'),
        ( 'hannity.com',                    '//meta[@property="article:published_time"]/@content'),
        ( 'funtobebad.blogspot.com',        '//h2[@class="date-header"]/span'),
        ...
        ( 'helenair.com',                   '//meta[@name="parsely-pub-date"]/@content'),
        ( 'herald-review.com',              '//meta[@name="parsely-pub-date"]/@content'),
        ...
        ( 'howafrica.com',                  '//meta[@property="article:published_time"]/@content'),
        ( 'hudsonreporter.com',             '//meta[@property="article:published_time"]/@content'),
        ( 'huffpost.com',                   '//meta[@property="article:published_time"]/@content'),
        ( 'ibtimes.com',                    '//meta[@property="article:published_time"]/@content'),
        ( 'icotalknews.com',                '//meta[@property="article:published_time"]/@content'),
        ( 'idahopoliticsdaily.com',         '//dd[@class="published"]/time/@datetime'),
        ( 'iknowallnews.com',               '//meta[@property="article:published_time"]/@content'),
        ( 'images.military.com',            '//meta[@property="article:published_time"]/@content'),
        ( 'in.news.yahoo.com',              '//time[@class="date Fz(11px) Mb(4px)  D(ib)"]/@datetime'),
        ( 'indiadying.blogspot.com',        '//h2[@class="date-header"]/span'),
        ( 'indianexpress.com',              '//meta[@property="article:published_time"]/@content'),
        ( 'hindi.moneycontrol.com',         '//div[@class="a_10mgry PT5"]'),
        ...
        ( 'periodicodebate.com',            '(//div[@class="itemIntroText"]/p/strong)[2]'),
        ( 'playadelcarmennoticias.com',     '//meta[@property="og:updated_time"]/@content'),
        ...
        ( 'radiosantafe.com',               '//meta[@property="article:published_time"]/@content'),
        ...
        ( 'theepochtimes',                  '//meta[@property="article:published_time"]/@content'),
        ( 'thefreelibrary.com',             '//table[@style="width:100%;border-spacing:0;border:none"]/tbody/tr[@class="odd"]/td/a'),
        ( 'thegatewaypundit.com',           '//meta[@property="article:published_time"]/@content'),
        ( 'theglobalist.com',               '//meta[@property="article:published_time"]/@content'),
        ...
        ( 'thehindu.com',                   '//meta[@name="publish-date"]/@content'),
        ( 'thehindubusinessline.com',       '//meta[@name="publish-date"]/@content'), 
        ( 'theindependent.com',             '//meta[@name="parsely-pub-date"]/@content'),
        ( 'theintercept.com',               '//span[@class="PostByline-date"]' ),
        ( 'thejournal.ie',                  '//meta[@property="article:post_date"]/@content'),
        ( 'thelibertybeacon.com',           '//span[@class="entry-meta-date updated"]/a'),
        ( 'thenation.com',                  '//meta[@property="article:published_time"]/@content'), 
        ...
        ( 'thesouthafrican.com',            '//meta[@property="article:published_time"]/@content' ),
        ( 'thestar.com',                    '//meta[@property="article:published_time"]/@content' ),
        ...
        ( 'theyeshivaworld.com',            '//meta[@itemprop="datePublished"]/@content'),
        ( 'theverge.com',                   '//meta[@property="article:published_time"]/@content'),
        ...
        ( 'trackpersia.com',                '//meta[@property="article:published_time"]/@content'),
...
def get_timestamp_modified(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'fox40.com',                      '//meta[@property="article:modified_time"]/@content' ),
        ( 'fox4kc.com',                     '//meta[@property="article:modified_time"]/@content' ),
        ( 'foxnews.com',                    '//div[@class="article-updated"]' ),
        ( 'freebeacon.com',                 '//meta[@property="article:modified_time"]/@content' ),
        ( 'gistmagazine.wordpress.com',     '//meta[@property="article:modified_time"]/@content' ),
        ( 'globalvoices.org',               '//meta[@property="article:modified_time"]/@content' ),
        ( 'greaterlakewood.com',            '//meta[@property="article:modified_time"]/@content'),
        ( 'guardian.ng',                    '//meta[@property="article:modified_time"]/@content'),
        ( 'guardianlv.com',                 '//meta[@property="article:modified_time"]/@content'),
        ( 'hotair.com',                     '//meta[@property="article:modified_time"]/@content'),
        ( 'howafrica.com',                  '//meta[@property="article:modified_time"]/@content'),
        ( 'hudsonreporter.com',             '//meta[@property="article:modified_time"]/@content'),
        ( 'huffpost.com',                   '//meta[@property="article:modified_time"]/@content'),
        ( 'ibtimes.com',                    '//meta[@property="article:modified_time"]/@content'),
        ( 'images.military.com',            '//meta[@property="article:modified_time"]/@content'),
        ( 'indianexpress.com',              '//meta[@property="article:modified_time"]/@content'),
        ...
        ( 'radiosantafe.com',               '//meta[@property="article:modified_time"]/@content'),
        ( 'theepochtimes',                  '//meta[@property="article:modified_time"]/@content'),
        ( 'thegatewaypundit.com',           '//meta[@property="article:modified_time"]/@content'),
        ( 'theglobalist.com',               '//meta[@property="article:modified_time"]/@content'),
        ( 'theglobeandmail.com',            '//meta[@property="article:modified_time"]/@content'),
        ( 'thehindu.com',                   '//meta[@name="modified-date"]/@content'),
        ( 'thehindubusinessline.com',       '//meta[@name="modified-date"]/@content'),
        ( 'thejournal.ie',                  '//meta[@property="article:post_modified"]/@content'),
        ( 'thenation.com',                  '//meta[@property="article:modified_time"]/@content'),
        ( 'thesouthafrican.com',            '//meta[@property="article:modified_time"]/@content' ), 
        ( 'thestar.com',                    '//meta[@property="article:modified_time"]/@content' ),
        ( 'theverge.com',                   '//meta[@property="article:modified_time"]/@content'),
        ( 'theyeshivaworld.com',            '//meta[@itemprop="dateModified"]/@content'),
        ( 'trackpersia.com',                '//meta[@property="article:modified_time"]/@content'),
