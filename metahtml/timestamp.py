...
def get_timestamp_published(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'breitbart.com',                  '//meta[@property="article:published_time"]/@content' ),
        ( 'breitbart.com',                  '(//time/@datetime)[1]' ),
        ( 'cbsnews.com',                    '//time/@datetime' ),
        ( 'chicagotribune.com',             '//meta[@name="date"]/@content' ),
        ( 'cnbc.com',                       '//meta[@itemprop="dateCreated"]/@content' ),
        ...
        ( 'fnad.info',                      '//meta[@property="published_time"]/@content' ),
        ...
        ( 'newsbreak.com',                  '//meta[@itemprop="dateCreated"]/@content' ),
        ( 'newsbreak.com',                  '//meta[@property="article:published_time"]/@content '),
        ( 'news.un.org',                    '//meta[@property="article:published_time"]/@content' ),
        ( 'ngong.net',                      '//meta[@property="published_time"]/@content' ),
        ( 'nydailynews.com',                '//meta[@name="date"]/@content'),
        ( 'nytimes.com',                    '//meta[@property="article:published"]/@content' ),
        #( 'nytimes.com',                    '//meta[@name="pdate"]/@content' ),
        #( 'nytimes.com',                    '(//time/@datetime)[1]' ),
        ...
        ( 'nzherald.co.nz',                 '//div[@class="publish"]' ),
        ...
        ( 'smartprices.org',                '//meta[@property="published_time"]/@content' ),
        ...
        ( 'sportbreakingnews.com',          '//meta[@property="published_time"]/@content' ),
        ( 'straitstimes.com',               '//meta[@property="article:published_time"]/@content' ),
        ( 'straitstimes.com',               '//meta[@property="og:updated_time"]/@content' ),
        #( 'straitstimes.com',               '//div[@class="story-postdate"]' ),
        ...
        ( 'vietnamartnews.com',             '//meta[@property="published_time"]/@content' ),
        ( 'voxeurop.eu',                    '//div[contains(@class,"publish_date_time")]' ),
        ( 'xbuy.info',                      '//meta[@property="published_time"]/@content' ),
...
def get_timestamp_modified(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'video.foxnews.com',              '//meta[@name="dcterms.modified"]/@content' ),
        ( 'fnad.info',                      '//meta[@property="modified_time"]/@content' ),
        ( 'gamemaz.info',                   '//meta[@property="modified_time"]/@content' ),
        ( 'gatofuns.com',                   '//meta[@property="modified_time"]/@content' ), 
        ( 'gooseart.net',                   '//meta[@property="modified_time"]/@content' ),       
        ( 'ngong.net',                      '//meta[@property="modified_time"]/@content' ),
        ( 'smartprices.org',                '//meta[@property="modified_time"]/@content' ),
        ( 'sportbreakingnews.com',          '//meta[@property="modified_time"]/@content' ),
        ( 'vietnamartnews.com',             '//meta[@property="modified_time"]/@content' ),
        ( 'xbuy.info',                      '//meta[@property="modified_time"]/@content' ),
