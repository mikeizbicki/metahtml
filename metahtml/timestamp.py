...
def get_timestamp_published(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'courrierinternational.com',      '//span[@class="date"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]'),
        ...
        ( 'dakaractu.com',                  '//div[@class="access"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ( 'dalloz-actualite.fr',            '//span[@class="field-field-published-at"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'diploweb.com',                   '//font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'jawharafm.net',                  '//span[@class="dat_ev"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'lci.fr',                         '(//time)[1]'),
        ( 'leaders.com.tn',                 '//div[@class="infos"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ( 'lecranstdenis.org',              '//time/@datetime' ),
        ( 'ledevoir.com',                   '//time/@datetime' ),
        ( 'legrandsoir.info',               '//div[@class="article-date  print-only"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'ozap.com',                       '//div[@class="article__author-date"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'pressafrik.com',                 '//div[@class="access"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'senenews.com',                   '//span[@class="date updated"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'touteleurope.eu',                '//span[@class="date"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ( 'townhall.com',                   '//div[@class="contributor pull-left"][contains(.,"Posted:")]/text()'),
        ( 'tvanouvelles.ca',                '//time[@itemprop="datePublished"]/@datetime' ),
        ...
        ( 'voaafrique.com',                 '//span[@class="date"]//time/@datetime' ),
...
def get_timestamp_modified(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'prepecn.com',                    '//div[@class="content-update"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ( 'renegadetribune.com',            '//span[@class="posted-on"]//time[@class="updated"]/@datetime' ),
        ( 'santepubliquefrance.fr',         '//div[@class="date"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ( 'senenews.com',                   '//span[@class="timeT"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
