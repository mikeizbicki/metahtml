...
def get_timestamp_published(html, url, **kwargs):
	...
	( 'japantimes.co.jp',		    '//time/[@pubdate datetime]' ),
	( 'lapresse.it',		    '//div[@class="article__main__metadata"]/span[@class=“article__main__date”]' ),
	( 'napolitoday.it',		    '//time[@class=“datestamp”]/[@data-timestamp=“q6tsvt”]' ),
	( 'sputniknews.com',		    '//time[@class=“b-article__refs-date”]/[@itemprop=“dataCreated”]/@datetime' ),
	( 'thehindu.com',		    '//span[@class=“blue-color ksl-time-stamp”]' ),
	( 'learningenglish.voanews.com',    '//div[@class = “published”]/span[@class=“date”]/time/@datetime' ),
	( 'macaudailytimes.com.mo',	    '//div[@class=“meta-data”]/span/i[@class =“fa fa-clock-o”] ' ),
	( 'mothership.sg',	    	    '//div[@class=“publish-info”]/span[@class=“publish-date”]' ),
	( 'mumbaimirror.indiatimes.com',    '//div[@class=“left”]/span[@class=“byline”]/span[@class=“divider”]' ),
	...
	( 'scotsman.com',		    '//div[@class=“sc-kgoBCf jscblI”]' ),
	...
	( 'studymode.com', 		    '//span[@class=“essay-details—grey text-s”]/strong' ),
	( 'techrepublic.com',		    '//span[@class=“byline-item”]/span[@class=“byline-item”]' ),
	( 'thedailybeast.com',		    '//span[@class=“PublicationTime__date-label”]' ),
