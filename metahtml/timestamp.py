...
def get_timestamp_published(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'mundoplast.com',                 '//span/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'news.biglobe.ne.jp',             '//p[@class="date"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ( 'news.bioon.com',                 '//p/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ( 'news.com.au',                    '//meta[@itemprop="datePublished"]/@content'),
        ( 'news.kakaku.com',                '//p[@class="date"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
        ...
        ( 'nk.jiho.jp',                     '//span[@class="date-display-single"]/font[@style="vertical-align: inherit;"]/font[@style="vertical-align: inherit;"]' ),
