...
def get_timestamp_modified(html, url, **kwargs):
    ...
    xpaths = [
        ...
        ( 'corse-machin.com',               '//meta[@property="article:modified_time"]/@content'),
        ( 'dailysabah.com',                 '//meta[@name="dateModified"]/@content'),
        ...
        ( 'foxnews.com',                    '//div[@class="article-updated"]' ),
        ( 'france24.com',                   '//meta[@property="article:modified_time"]/@content'),
        ( 'francetvinfo.fr',                '//meta[@property="article:modified_time"]/@content'),
        ( 'globalsecurity.org',             '//div[@id="modified"]' ),
        ( 'huffingtonpost.fr',              '//meta[@property="article:modified_time"]/@content'),
        ( 'impots.gouv.fr',                 '//meta[@property="article:modified_time"]/@content'),
        ( 'infirmiers.com',                 '//time[@itemprop="dateModified"]/@datetime'),
        ( 'informacyde.com',                '//meta[@property="article:modified_time"]/@content'),
        ( 'islamsounnah.com',               '//meta[@property="article:modified_time"]/@content'),
        ( 'jeuneafrique.com',               '//meta[@property="article:modified_time"]/@content'),
        ( 'latribune.fr',                   '//span[@itemprop="Publisher"]/meta[@itemprop="dateModified"]/@content'),
        ( 'lefigaro.fr',                    '//meta[@property="article:modified_time"]/@content'),
        ...
        ( 'pandasecurity.com',              '//meta[@property="article:modified_time"]/@content'),
        ( 'politicalislam.com',             '//meta[@property="article:modified_time"]/@content'),
        ( 'politico.com',                   '//p[@class="story-meta__updated"]/time/@datetime'),
        ( 'politico.com',                   '//span[@class="updated"]'),
        ( 'politis.fr',                     '//meta[@property="article:modified_time"]/@content'),
        ( 'renegadetribune.com',            '//span[@class="posted-on"]//time[@class="updated"]/@datetime' ),
        ( 'rtbf.be',                        '//meta[@property="article:modified_time"]/@content'),
        ( 'senenews.com',                   '//span[@class="date updated"]' ),
        ( 'service-public.fr',              '(//p[@class="date"]/text())[1]'),
        ( 'sunnisme.com',                   '//meta[@property="article:modified_time"]/@content'),
        ( 'tsa-algerie.com',                '//meta[@property="article:modified_time"]/@content'),
        ( 'turquie2023.com',                '//meta[@property="article:modified_time"]/@content'),
        ( 'tvanouvelles.ca',                '//p[@class="date-line"]/time/@datetime'),
        ( 'tvanouvelles.ca',                '//time[@itemprop="dateUpdated"]/@datetime' ),
        ( 'un.org',                         '//meta[@property="article:modified_time"]/@content'),
        ( 'upi.com',                        '//div[@class="article-date"]/span'),
        ( 'varmatin.com',                   '//meta[@property="article:modified_time"]/@content'),
        ...
        ( 'wsws.org',                       '//meta[@name="dateModified"]/@content'),
