...
def get_timestamp_modified(html, url, **kwargs):
    ...
    xpaths = [
        ...
        #( 'persee.fr',                      '//meta[@itemprop="dateModified"]/@content'),
        #( 'researchgate.net',               '//meta[@itemprop="dateModified"]/@content'),
        #( 'securitepublique.gc.ca',         '//meta[@name="dcterms.modified"]/@content'),
        ( 'service-public.fr',              '(//p[@class="date"]/text())[1]'),
        ( 'ut-capitole.fr',                 '//meta[@name="Date-Revision-yyyymmdd"]/@content'),
