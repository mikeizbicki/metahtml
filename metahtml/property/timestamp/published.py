...
class Extractor(TimestampExtractor):
    ...
    xpaths = [
        ...
        ( 'laptopspirit.fr',                '//div[@class="post-meta vcard"]/p/span[@class="updated"]' ),
        ...
        ( 'lirinabloom.blogspot.com',       '//span[@class="post-timestamp"]/a[@class="timestamp-link"]/abbr[@class="published"]/@title'),
